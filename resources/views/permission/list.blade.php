            ...
            <div class="container-fluid my-2">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <a href="{{ route('permissionCreate') }}" class="btn btn-primary">New Permission</a>
                    </div>
                </div>
            </div>
            <!-- /.container-fluid -->
                    ...
                    <form action="" method="get">
                        <div class="card-header">
                            <div class="card-title">
                                <button type="button" onclick="window.location.href='{{ route('permission') }}'"
                                    ...
                                    @foreach ($permissions as $permission)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('permissionDelete', $permission->id) }}"
