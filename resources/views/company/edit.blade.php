...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            <form action="{{ route('companyUpdate', $company->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Name" value="{{ old('name', $company->name) }}">
                                        @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="website" id="website" class="form-control @error('website') is-invalid @enderror"
                                        placeholder="Website" value="{{ old('website', $company->website) }}">
                                        @error('website')
                                            <p class="invalid-feedback">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            @if ($company->logo)
                                <div class="mt-3">
                                    <p>Current Image:</p>
                                    <img src="{{ asset('storage/company/' . $company->logo) }}" alt="Company Logo"
                                        width="300">
                                </div>
                            @endif
                        </div>
